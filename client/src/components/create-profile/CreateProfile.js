...
class CreateProfile extends Component {
  ...
  render() {
    ...
    const options = [
      ...
      {
        label: "Intsructor or Teacher",
        value: "Intsructor or Teacher"
      },
      {
        label: "Intern",
        value: "Intern"
            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <TextFieldGroup
                  ...
                  info="Country and provice/state (eg. South Africa, Gauteng)"
                />
                ...
                <TextFieldGroup
                  ...
                  info="If you want your latest repos and a Github link added to your profile"
                />
